    ...
    <main role="main" class="animsition" data-animsition-in-class="fade-in-left-sm" data-animsition-in-duration="1000" data-animsition-out-class="fade-out-left-sm" data-animsition-out-duration="1500">
        ...
        <div id="security" role="banner" class="jumbotron jumbotron-fluid d-flex flex-column justify-content-center align-items-center text-center bg-img-banner-security text-white min-70 p-5 mb-0 content-tween">
            ...
            <h1 class="site-title relative z-1 x-bold m-0 mb-1">
                ...
                <span class="d-inline-block">is</span>
            ...
            <h2 class="site-sub-title relative z-1 pt-1 pb-3">
                ...
                <span class="d-inline-block">most</span>
                <span class="d-inline-block">secure</span>
                <span class="d-inline-block">cryptocurrency</span>
                <span class="d-inline-block">wallet</span>
                <span class="d-inline-block">available</span>
            </h2>
        </div>
           ...
           <!--row 3 additional features-->
            ...
            <div class="row d-flex bg-white min-100 content-tween">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left bg-dots min-50 p-5 rellax">
                    ...
                    <p class="border-top py-3 content-stagger-up">Users are not required to provide personal information to interact with their digital assets. We care about safeguarding your digital assets and protecting your identity.</p>
                </div><!--end col-->
            </div><!--end row-->           
