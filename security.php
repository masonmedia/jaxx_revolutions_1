        ...
        <div class="container-fluid p-0">
           ...
           <!--row 2 security features-->
            <div class="row d-flex bg-img-banner-security relative z-1 content-tween">
                ...
                <div class="col-lg-6 bg-img-hand-device p-0 content-stagger-up"></div>
            </div><!--end row-->
...
<!--
                <div class="col-xl-4 col-md-6 d-flex flex-column justify-content-start align-items-start min-50 bg-orange text-light p-5 rellax">
                    <div class="wrap p-4 border border-light min-50 content-stagger-up">
                        <img class="jaxx-navbar-brand content-stagger-up" src="/img/Jaxx_Icon_Reversed_Large_RGB_Screen.png" alt="Jaxx Liberty Security">
                        <h2 class="font-weight-bold p-3 bg-navy orange skew shadow-lg py-2 content-stagger-up">New Model</h2>
                        <p class="border-top border-light py-3 content-stagger-up">Our new and improved security model in Jaxx Liberty offers the option to encrypt sensitive information with a strong alphanumeric password.  </p>
                    </div>
                </div>
-->
            <div class="row d-flex bg-img-banner-security bg-dots shadow-lg content-tween">
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-light bg-orange p-5">
...
<!--
            <div class="row d-flex bg-white min-100 content-tween">
                ...
                <div class="col-lg-6 d-flex flex-column justify-content-center align-items-start text-left bg-dots min-50 p-5 rellax">
                    <img class="jaxx-navbar-brand content-stagger-up" src="/img/Jaxx_Primary_Icon_RGB_Screeen.svg" alt="Jaxx Liberty Security">
                    <h3 class="font-weight-bold bg-navy orange skew shadow-lg p-3 mb-5 content-stagger-up">No personal information required</h3>
