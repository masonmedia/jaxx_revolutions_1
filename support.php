...
?>
    ...
    <main id="support" role="main" class="content-tween animsition" data-animsition-in-class="fade-in-up-sm" data-animsition-in-duration="1000" data-animsition-out-class="fade-out-left-sm" data-animsition-out-duration="1500">
               ...
               <div class="col-sm-12 d-flex flex-column justify-content-center align-items-center pb-5">
                   <div class="d-flex flex-column justify-content-center align-items-center pb-3 rellax" data-rellax-speed="-2">
                        ...
                        <h2 class="site-sub-title">
                            ...
                            <span class="d-inline-block">official</span>
        ...
        <div class="container-fluid p-0">
            ...
            <!--row 1 support intro-->
            <div id="sec-features" class="row d-flex bg-white bg-img-support-welcome py-3">
           ...
           <!--row 2 support grid options-->
            <div class="row d-flex justify-content-center align-items-center relative z-1 bg-navy px-3 content-tween">
               <div class="col-xl-4 d-flex flex-column justify-content-start align-items-start bg-navy text-white min-50 p-4">
           ...
           <div class="row bg-orange text-white min-50 content-tween">
               <div class="col-sm-12 d-flex flex-column justify-content-center align-items-center text-center min-70 bg-download-gradient p-4 parallelo slide-in-right">
