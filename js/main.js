 $(document).ready(function () {
   ...
   tl.from(".navy-bg", 0.5, {
     ...
     .staggerFrom(".navbar-brand, .nav-item", 0.3, {
       autoAlpha: 0,
       y: -10,
       rotation: -20
     }, 0.1)
     //fade in toggler
     .from(".navbar-toggler", 0.3, {
       autoAlpha: 0,
       y: -10,
       rotation: -30
     }, "-=0.25")
     ...
     // fade in logo fill 
     .to("#home .jaxx-logo .st1", 1, {
       fill: "#ff6902",
       ease: SlowMo.easeIn
     })

     // fade in logo fill 
     .to("#home .jaxx-logo .st0", 1, {
       fill: "#fff",
       ease: SlowMo.easeIn
     }, "-=0.5")

     // explode out left JAX
     .to("#home .jaxx-logo .st0", 0.5, {
       y: 1000,
       ease: Power4.easeInOut
     })

     // explode out down X
     .to("#home .jaxx-logo .st1", 0.5, {
       x: -1000,
       ease: Power4.easeInOut
     })

     // explode out down Liberty
     .staggerTo("#home .jaxx-logo .st2", 0.5, {
       y: -1000,
       ease: Power4.easeInOut
     }, 0.1)

     //fade in orange-bg 
     .from("#home .orange-bg", 0.5, {
       autoAlpha: 0,
       ease: SlowMo.easeInOut
     })

     //fade out Jaxx Logo
     .to("#home .jaxx-logo", 0.5, {
       autoAlpha: 0,
       display: "none",
       ease: SlowMo.easeInOut
     })
     ...
     .staggerFrom("#home .banner-span", 0.5, {
       y: -100,
       autoAlpha: 0,
       ease: SlowMo.easeInOut
     }, 0.3, "-=0.5")
     ...
     .staggerFrom(".sub-tagline-1, .sub-tagline-2, .sub-tagline-3", 0.2, {
       y: -20,
       autoAlpha: 0,
       ease: SlowMo.easeInOut
     }, 0.5)
     ...
     //fade in bg image
     .from("#home .banner-img", 1, {
       autoAlpha: 0,
       ease: Power1.easeIn
     }, "-=0.5")

     // fade in heart svg bg
     .from("#home .jaxx-heart-logo", 0.5, {
       y: -10,
       autoAlpha: 0,
       ease: Back.easeInOut
     }, "-=0.25")
   ...
   tl2.staggerFrom("#banner .navbar-brand, .nav-item, .navbar-toggler", 0.2, {
       y: -10,
       autoAlpha: 0,
       rotation: -20
     }, 0.1)
     .staggerFrom("#banner h1 span", 0.5, {
       autoAlpha: 0,
       x: -500,
       rotation: -100,
       ease: SlowMo.easeIn
     }, 0.1)
     .from("#banner .jaxx-navbar-brand", 0.5, {
       autoAlpha: 0,
       y: -20,
       ease: SlowMo.easeIn
     })
     ...
     .staggerFrom("#banner h2 span", 0.5, {
       autoAlpha: 0,
       y: 20,
       ease: SlowMo.easeIn
     }, 0.1)
   ...
   tl3.staggerFrom(".navbar-brand, .nav-item, .navbar-toggler", 0.2, {
       y: -10,
       autoAlpha: 0,
       rotation: -20
     }, 0.1)
     .from("#security .security-shield", 1, {
       autoAlpha: 0,
       y: -20,
       ease: SlowMo.easeIn
     }, "-=0.25")
     .staggerFrom("#security .site-title span", 0.5, {
       autoAlpha: 0,
       y: -50,
       ease: SlowMo.easeInOut
     }, 0.2)
     .from("#security hr", 0.5, {
       autoAlpha: 0,
       x: 500,
       rotation: -100,
       ease: SlowMo.easeIn
     }, "-=0.5")
     .from("#security h2 span", 0.5, {
       autoAlpha: 0,
       y: 20,
       ease: SlowMo.easeIn
     }, "-=0.25");
   ...
   tl4.staggerFrom("#features .bg-img-banner-features", 0.5, {
       y: -10,
       autoAlpha: 0,
       rotation: -20
     }, 0.1)
     .staggerFrom("#features .page-title span", 0.5, {
       autoAlpha: 0,
       x: -500,
       rotation: -100,
       ease: SlowMo.easeIn
     }, 0.1)
     .from("#features hr", 0.5, {
       autoAlpha: 0,
       x: 500,
       rotation: -100,
       ease: SlowMo.easeIn
     }, "-=0.5")
     .staggerFrom("#features h2 span", 0.5, {
       autoAlpha: 0,
       y: 20,
       ease: SlowMo.easeIn
     }, 0.1)
     .from("#features .jaxx-navbar-brand", 0.5, {
       autoAlpha: 0,
       y: -20,
       ease: SlowMo.easeIn
     }, "-=0.25");
   ...
   $(".fade-out").each(function () {
     ...
     var fadeOut = TweenMax.to(this, 2, {
       autoAlpha: 0,
       delay: 0,
       ease: SlowMo.easeOut
     }, .5);
   ...
   $(".slide-in-left").each(function () {
     ...
     var slideInLeft = TweenMax.from(this, 2, {
       autoAlpha: 0,
       x: 1000,
       delay: 0,
       ease: Expo.easeInOut
   ...
   $(".content-tween").each(function () {
     ...
     var contentTween = contentTweenTL.from($(this).find(".content-tween-left"), 0.5, {
         x: -200,
         autoAlpha: 0,
         delay: 0,
         ease: Power4.easeInOut
       }, .1)
       .from($(this).find(".content-tween-right"), 0.5, {
         x: 200,
         autoAlpha: 0,
         delay: 0,
         ease: Power4.easeInOut
       }, .1)
       .from($(this).find(".content-tween-up"), 0.5, {
         y: 200,
         autoAlpha: 0,
         delay: 0,
         ease: Power4.easeInOut
       }, .1)
       .from($(this).find(".content-tween-down"), 0.5, {
         y: -200,
         autoAlpha: 0,
         delay: 0,
         ease: Power4.easeInOut
       }, .1)
       .staggerFrom($(this).find(".content-stagger-up"), 0.8, {
         y: 200,
         autoAlpha: 0,
         delay: 0,
