    ...
    <main class="animsition" data-animsition-in-class="fade-in-right-sm" data-animsition-in-duration="1000" data-animsition-out-class="fade-out-left-sm" data-animsition-out-duration="1500">
       ...
       <!--jumbotron-->
        ...
        <div class="container-fluid bg-white bg-img-multidevice-outline p-0">
            ...
            <!--row 1-->
            <div id="row1" class="row d-flex bg-orange-angle content-tween">
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-end text-right min-70 p-5">
                   <!--color bg div-->
                    <div class="img-full bg-orange-angle absolute z-0 left-0 content-stagger-up" data-rellax-speed="2"></div>
                    <div class="wrap rellax" data-rellax-speed="-2">
                        ...
                        <h2 class="page-title x-bold content-stagger-up">Unified Dashboard</h2>
                        <h4 class="content-stagger-up">View your digital assets in a streamlined and easy-to-use interface.</h4>
                    </div>
                    </div>
                <div class="col-lg-5 d-flex flex-column justify-content-center align-items-center bg-img-downloads min-50 slide-in-left">
                    <!--color bg div-->
             ...
             <!--row 2-->
            <div id="row2" class="row d-flex bg-turq-angle-right content-tween">
                <div class="col-lg-5 d-flex justify-content-end align-items-center bg-img-downloads min-50 relative z-1 o-12 slide-in-right">
                    <!--device-->
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-start relative z-0 min-70 p-5 rellax" data-rellax-speed="-2">
                    <!--color bg div-->
                    <div class="img-full absolute bg-turq-angle-right z-0 right-0 content-stagger-up" data-rellax-speed="2"></div>
                    <div class="wrap rellax" data-rellax-speed="-2">
                        <img class="content-stagger-up" src="/img/icons/jaxx-port.png" alt="Jaxx Liberty Portfolio">
                        <h2 class="page-title x-bold content-stagger-up">Portfolio</h2>
                        <h4 class="content-stagger-up">Stay on top of your digital asset value with our new Portfolio module.</h4>
                    </div>
                </div>
            ...
            <!--row 3 News-->
            <div id="row3" class="row bg-orange-angle d-flex content-tween rellax">
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-end text-right min-70 p-5 rellax" data-rellax-speed="-2">
                    <!--color bg div-->
                    <div class="img-full bg-orange-angle absolute z--1 left-0 content-stagger-up" data-rellax-speed="2"></div>
                    <div class="wrap rellax" data-rellax-speed="-2">
                        <img class="mb-2 content-stagger-up" src="/img/icons/jaxx-data.png" alt="Jaxx Liberty Aggregated Headline News">
                        <h2 class="page-title x-bold content-stagger-up">Blockchain News</h2>
                        <h4 class="content-stagger-up">Your launchpad to the latest aggregated news.</h4>
                    </div>
                </div>
                <div class="col-lg-5 d-flex justify-content-start align-items-center bg-img-downloads min-50 relative z-1 p-4 slide-in-left">
                    <!--device-->
            ...
            <div id="row4" class="row d-flex bg-turq-angle-right content-tween rellax">
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-start min-70 p-5 slide-in-left">
                    <!--color bg div-->
                    <div class="img-full bg-turq-angle-right absolute z-0 right-0 content-stagger-up" data-rellax-speed="2"></div>
                    <div class="wrap rellax" data-rellax-speed="-2">
                        <img class="content-stagger-up" src="/img/icons/jaxx-news.png" alt="Jaxx Liberty Market Data">
                        <h2 class="page-title x-bold content-stagger-up">Market Data</h2>
                        <h4 class="content-stagger-up">Price moves, market caps and trends at your fingertips.</h4>
                    </div>
                </div>
            </div>
            
            <!--row 5 Block Explorer-->
             <div id="row5" class="row bg-orange-angle d-flex content-tween">
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-end text-right min-70 p-5">
                    <!--color bg div-->
                    <div class="img-full bg-orange-angle absolute z-0 left-0 content-stagger-up" data-rellax-speed="2"></div>
                    <div class="wrap rellax" data-rellax-speed="1">
                        ...
                        <h2 class="page-title x-bold content-stagger-up">Block Explorer</h2>
