...
?> 
    ...
    <main role="main">
        ...
        <!--jumbotron-->
        <div class="jumbotron jumbotron-fluid d-flex flex-column justify-content-center align-items-center text-center bg-img-banner-thirdparties min-70 p-5 mb-0 content-tween">
       ...
       <!--container-->
        ...
        <div id="thirdPartyIntegrations" class="col-sm-12">
            ...
            <p class="py-2">The following is a list of third parties that are exposed to Jaxx users’ personal information.</p>
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td>Cookies for Web analytics.</td>
                      <td>Browsing habits; track user behaviour.</td>
                    </tr>
                  </tbody>
                </table>
            </div><!--end table-->
