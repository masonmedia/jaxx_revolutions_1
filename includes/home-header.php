...
window.cookieconsent.initialise({
  ...
  "content": {
    "message": "We use cookies to ensure you get the best experience on our website. Check out our terms of service for",
    "dismiss": "Okay!",
    "link": "more info.",
    "href": "www.jaxx.io/legal"
  }
})});
</script>
</head>
...
<![endif]-->
    ...
    <nav class="navbar fixed-top navbar-expand-lg">
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo02" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
            <img class="jaxx-mobile-menu" src="/img/jaxx-menu-orange.png" alt="Jaxx Liberty Menu">
        </button>
